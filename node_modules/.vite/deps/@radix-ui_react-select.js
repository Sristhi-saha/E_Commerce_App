...
function dispatchDiscreteCustomEvent(target, event) {
	if (target) import_react_dom$9.flushSync(() => target.dispatchEvent(event));
}
...
var Portal$1 = import_react.forwardRef((props, forwardedRef) => {
	...
	return container ? import_react_dom$3.createPortal(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$2.div, {
		...portalProps,
		ref: forwardedRef
	}), container) : null;
});
